...
export const Route = createFileRoute("/merchant/login")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "تسجيل دخول التجار إلى لوحة إدارة المتجر." },
    ],
  }),
});
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-3xl border border-border bg-card p-7 sm:p-8" style={{ boxShadow: "0 20px 60px -30px color-mix(in oklab, var(--primary) 40%, transparent)" }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[10px] font-semibold tracking-[0.22em] uppercase text-primary/80">Merchant</div>
              <h1 className="font-display text-2xl font-extrabold">لوحة التاجر</h1>
            </div>
          </div>
          <p className="mt-3 text-sm text-muted-foreground">سجّل دخولك ببيانات المتجر اللي وصلتك من إدارة آش مول.</p>
          ...
          <div className="mt-5 text-center text-xs text-muted-foreground">
            مش معاك بيانات؟ تواصل مع إدارة آش مول
          </div>
        </div>
      </div>
    </div>
