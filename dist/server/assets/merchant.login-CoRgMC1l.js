...
import { ArrowLeft, Briefcase, Mail, Lock, Loader2 } from "lucide-react";
...
function MerchantLogin() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      toast.success("أهلاً بك في لوحة المتجر");
    ...
    /* @__PURE__ */ jsxs("div", { className: "rounded-3xl border border-border bg-card p-7 sm:p-8", style: {
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-[10px] font-semibold tracking-[0.22em] uppercase text-primary/80", children: "Merchant" }),
          /* @__PURE__ */ jsx("h1", { className: "font-display text-2xl font-extrabold", children: "لوحة التاجر" })
        ] })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "سجّل دخولك ببيانات المتجر اللي وصلتك من إدارة آش مول." }),
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-5 text-center text-xs text-muted-foreground", children: "مش معاك بيانات؟ تواصل مع إدارة آش مول" })
    ] })
  ] }) });
}
export {
  MerchantLogin as component
};
